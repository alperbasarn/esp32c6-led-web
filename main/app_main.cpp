...
<div class="kv-line"><span>Built</span><span id="firmwareBuildDateTime">-</span></div>
...
const firmwareBuildDateTime = document.getElementById('firmwareBuildDateTime');
